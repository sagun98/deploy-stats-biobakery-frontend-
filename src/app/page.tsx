...
export default function Home() {
    ...
    // Bioconductor stats are baked into /bioc-stats.json at build time by scripts/fetch-bioc-stats.mjs.
    // Served from Vercel's CDN — instant, no function timeout possible.
